...
Quality Checks
Script Purpose:
    In this script, I performed various quality checks for data consistency, accuracy, 
...
*/
-- Checking 'silver.crm_customer_info'Table
...
-- Checking 'silver.crm_product_info' Table
